...
import com.diac.awesomehardwaresupply.knowledgebase.repository.container.KnowledgebasePostgreSQLContainer;
...
public abstract class AbstractPostgreSQLContainerInitializer {
    ...
    @Container
    private static final PostgreSQLContainer<?> DB_CONTAINER = KnowledgebasePostgreSQLContainer.getInstance();
