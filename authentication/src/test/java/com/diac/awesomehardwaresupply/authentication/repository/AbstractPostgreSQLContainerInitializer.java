...
import com.diac.awesomehardwaresupply.authentication.repository.container.AuthenticationPostgreSQLContainer;
...
public abstract class AbstractPostgreSQLContainerInitializer {
    ...
    @Container
    private static final PostgreSQLContainer<?> DB_CONTAINER = AuthenticationPostgreSQLContainer.getInstance();
